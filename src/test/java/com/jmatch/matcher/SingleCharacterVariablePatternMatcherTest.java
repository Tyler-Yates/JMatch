...
public class SingleCharacterVariablePatternMatcherTest {

    private SingleCharacterVariablePatternMatcher matcher;

    @Before
    public void init() throws Exception {
        matcher = new SingleCharacterVariablePatternMatcher("abba");
    }
