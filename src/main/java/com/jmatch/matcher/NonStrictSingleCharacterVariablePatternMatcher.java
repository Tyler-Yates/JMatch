 ...
 */
public class NonStrictSingleCharacterVariablePatternMatcher extends SingleCharacterVariablePatternMatcher {
     ...
     */
    NonStrictSingleCharacterVariablePatternMatcher(String pattern) {
        super(pattern);
    }
